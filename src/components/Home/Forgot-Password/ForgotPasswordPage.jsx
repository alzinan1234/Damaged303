...
export default function ForgotPasswordFlow() {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const res = await fetch(
        "https://parental-creek-latin-monroe.trycloudflare.com/api/dashboard/auth/resend-otp/",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ email }),
  ...
  const handleResetSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://parental-creek-latin-monroe.trycloudflare.com/api/dashboard/auth/reset-password/",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
